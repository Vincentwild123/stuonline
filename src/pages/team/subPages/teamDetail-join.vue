  ...
  <view class="contain" v-if="!isLoad">
    ...
    <view class="compos-teamMembers">
      <team-member
        ...
        :teamLeaderInfo="teamInfo.leaderInfo"
        :teamMembers="teamInfo.membersInfo"
      ></team-member>
    </view>
    <!-- 3个选择操作区 -->
    <view
      class="letColumnCenter item-xuanze"
      v-for="(item, index) in xuanze1"
      v-if="item.isShow"
    ...
    <!-- 解散团队或退出团队 -->
    <view class="letallCenter item-xuanze"
      ><text class="item-xuanze-text1">{{ xuanze2[xuanze2_index] }}</text></view
    >
  </view>
</template>
