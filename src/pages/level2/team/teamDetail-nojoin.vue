<template>
	<view class="contain flex-column" v-if="!isLoad">
		<view class="compos-pageTop">
			<page-top backTitle="所有团队" :title="teaminfor.teamName" class="compos-pageTop-item"></page-top>
		</view>
		<view class="compos-teaminfor">
			<team-intro :teaminfor="teaminfor" class="compos-teaminfor-item" :isNoJoin="true"></team-intro>
		</view>
		<view class="compos-teamMembers">
			<team-member class="compos-teamMembers-item" :teamMembers="teaminfor.membersInfo" :teamLeaderInfo="teaminfor.leaderInfo"></team-member>
		</view>
		<view class="compos-activity flex-column">
			<view class="compos-activity-title"><text>团队活动</text></view>
			<activity-item class="compos-activity-item"v-for="index in 3"></activity-item>
		</view>
	</view>
</template>

<script>
import teamIntro from "@/src/pages/level1/team/teamCompos/teamIntro.vue";
