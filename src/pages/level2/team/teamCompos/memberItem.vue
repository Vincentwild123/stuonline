	...
	<view class="flex-row contain">
		<view class="left flex-row">
			<view class="letColumnCenter imgItem">
				<view class="teamImg-body letallCenter" v-if="isShow"><text>队长</text></view>
		...
		<view class="selectIcon letColumnCenter" v-if="isManaged && !isLeader">
			<uniIcon type="xuanze" color="#F4912F"  size='15' v-if="!isSelect" :index="index"></uniIcon>
			<uniIcon type="xuanze1" color="#F4912F"  size='15' v-if="isSelect" :index="index"></uniIcon>
		</view>
	</view>
</template>
